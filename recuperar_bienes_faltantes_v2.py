#!/usr/bin/env python3
"""
Script para recuperar los 668 bienes faltantes - VERSION 2
Incluye truncamiento de campos según límites de BD
"""
...
print("\n" + "="*70)
print("RECUPERAR BIENES FALTANTES v2 (CON TRUNCAMIENTO)")
print("="*70 + "\n")
    ...
    try:
        ...
        for idx, row in enumerate(bienes_faltantes, 1):
            try:
                ...
                # Commit cada 50 registros (más frecuente para evitar acumular errores)
                if idx % 50 == 0:
                    db.session.commit()
        ...
        if total_final >= 12800:
            ...
            print(f"\n[ESTADO] {total_final - 12158} bienes recuperados de {len(bienes_faltantes)} faltantes")
