#!/usr/bin/env python3
"""
Script para sincronizar bienes con CAL 2025 actualizado a Cloud SQL
"""
...
def sync_actualizados():
    """Sincronizar bienes actualizados con CAL 2025"""

    print("=" * 80)
    print("SINCRONIZAR BIENES CON CAL 2025 ACTUALIZADO A CLOUD SQL")
    print("=" * 80)
    ...
    try:
        ...
        with app.app_context():
            ...
            # Leer el SQL de bienes actualizados
            sql_file = Path(__file__).parent / 'sync_bienes_actualizados.sql'
